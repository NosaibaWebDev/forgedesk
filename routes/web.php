...
Route::middleware('auth')->group(function () {
    ...
    Route::get('files/{file}/download', [FileDownloadController::class, 'projectFile'])
        ->name('file.download.project-file')
        ->middleware('signed');
    Route::get('files/{file}/preview', [FileDownloadController::class, 'projectFilePreview'])
        ->name('file.preview.project-file')
        ->middleware('signed');
    Route::get('images/{image}/view', [FileDownloadController::class, 'taskImage'])
        ->name('file.download.task-image')
        ->middleware('signed');
});
...
Route::middleware(['auth', 'admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::put('api/dashboard/clear-all', [App\Http\Controllers\Admin\DashboardController::class, 'clearAll'])->name('api.dashboard.clear-all')->middleware(['throttle:api', 'password.confirm']);
    ...
    Route::post('projects/{project}/tasks/{task}/status', [AdminTaskController::class, 'updateStatus'])->name('projects.tasks.update-status');
    ...
    Route::delete('clients/{client}', [ClientController::class, 'destroy'])->name('clients.destroy')->middleware('password.confirm');

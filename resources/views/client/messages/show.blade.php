...
@section('title', 'שיחה - ' . $project->title)
@section('breadcrumbs')
<nav class="flex items-center gap-2 text-sm">
    ...
    <a href="{{ route('client.messages.index') }}" class="text-ink-muted hover:text-accent transition">הודעות</a>
    <i data-lucide="chevron-left" class="w-3.5 h-3.5 text-ink-muted"></i>
...
<div class="max-w-3xl mx-auto">
    <div class="bg-white rounded-card border border-border shadow-card overflow-hidden">
        <div class="px-6 py-4 border-b border-border bg-gray-50/80">
            ...
            <p class="text-xs text-ink-muted mt-0.5">שיחה עם מנהל המערכת</p>
        </div>
        ...
        <div class="p-6 max-h-[500px] overflow-y-auto space-y-4" id="messages-container">
            ...
            @empty
                <p class="text-center text-ink-muted py-12">אין הודעות עדיין. שלח הודעה ראשונה!</p>
            @endforelse
        </div>

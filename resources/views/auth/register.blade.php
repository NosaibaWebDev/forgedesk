...
<head>
    ...
    <title>{{ __('register') }} - {{ \App\Models\Setting::get('app_name', 'ForgeDesk Studio') }}</title>
    ...
    <div class="w-full max-w-md px-4">
        <div class="rounded-card border shadow-card p-8 transition-colors" style="background:var(--color-card); border-color:var(--color-border);">
            <div class="text-center mb-8">
                ...
                <p class="mt-1.5 text-sm" style="color:var(--color-ink-secondary);">{{ __('register_title') }}</p>
            </div>
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="mb-5">
                    <label for="name" class="label">{{ __('full_name') }}</label>
                    <input
                        type="text"
                        id="name"
                        name="name"
                ...
                <div class="mb-5">
                    <label for="phone" class="label">{{ __('phone_optional') }}</label>
                    <input
                        type="tel"
                        id="phone"
                        name="phone"
                ...
                <div class="mb-6">
                    <label for="password_confirmation" class="label">{{ __('password_confirm') }}</label>
                    <input
                        type="password"
